...
//  Drawing App
//
//  Created by Aidin Ahmadian on 05/02/22.
//
...
class FilterView: UIView {
    ...
    let categories = ["Sort" , "Brushes", "More"]
    ...
    let clearAllBtn: UIButton = {
        ...
        btn.setTitleColor(#colorLiteral(red: 0.2, green: 0.262745098, blue: 0.2196078431, alpha: 1), for: .normal)
    ...
    let applyBtn: UIButton = {
        ...
        btn.backgroundColor = #colorLiteral(red: 0.2, green: 0.262745098, blue: 0.2196078431, alpha: 1)
